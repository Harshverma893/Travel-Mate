...
public class SixthFragment extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        Button btnOpenSlideShow2 = (Button) view.findViewById(R.id.btnOpenSlideShow2);
        btnOpenSlideShow2.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                SeventhFragment seventhFragment = new SeventhFragment() ;
                FragmentManager manager = getFragmentManager();
                manager.beginTransaction().
                        replace(R.id.content, seventhFragment, seventhFragment.getTag()).commit();
